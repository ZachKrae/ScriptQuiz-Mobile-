...
export default function Game(props) {
	...
	var answerKey = [
		<TouchableHighlight 
			...
			onPress={()=> handleAnswerButtonClick(props.alphabet[currentQuestion].latin)}>
			<Text style={styles.headingText}>{props.alphabet[currentQuestion].latin}</Text>
		</TouchableHighlight>,
		<TouchableHighlight 
			style={styles.answerButton} 
			underlayColor={'orange'} 
			onPress={()=> handleAnswerButtonClick(props.alphabet[pickedTwo].latin)}>
			<Text style={styles.headingText}>{props.alphabet[pickedTwo].latin}</Text>
		</TouchableHighlight>,
		<TouchableHighlight 
			style={styles.answerButton} 
			underlayColor={'orange'} 
			onPress={()=> handleAnswerButtonClick(props.alphabet[pickedThree].latin)}>
			<Text style={styles.headingText}>{props.alphabet[pickedThree].latin}</Text>
		</TouchableHighlight>,
		<TouchableHighlight 
			style={styles.answerButton} 
			underlayColor={'orange'} 
			onPress={()=> handleAnswerButtonClick(props.alphabet[pickedFour].latin)}>
			<Text style={styles.headingText}>{props.alphabet[pickedFour].latin}</Text>
		</TouchableHighlight>
	]
