...
const SelectLang = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Arabic)}>
            ...
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Georgian)}>
                <Text style={styles.buttonText}>Georgian (Mkhedruli)</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Greek)}>
                <Text style={styles.buttonText}>Greek</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Hebrew)}>
                <Text style={styles.buttonText}>Hebrew</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Hiragana)}>
                <Text style={styles.buttonText}>Japanese (Hiragana)</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Katakana)}>
                <Text style={styles.buttonText}>Japanese (Katakana)</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Korean)}>
                <Text style={styles.buttonText}>Korean</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(Persian)}>
                <Text style={styles.buttonText}>Persian</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.selecterButton} onPress={() => selectAnAlph(RusCyrillic)}>
